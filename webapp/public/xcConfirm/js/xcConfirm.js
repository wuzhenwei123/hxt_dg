...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $txt = $("<div>").html(popHtml);//弹窗文本dom
		//var $tt = $("<span>").addClass("tt").text(config.title);//标题
		var $tt = $("<span>").addClass("tt").html(config.title);//标题
		...
		function getBtn(){
			var a = '';
			if(config.isOkBtn){
				a = $btnArea.append(creatBtnGroup(btn))
			}
			return a;
		}
...
//			console.log(this)
			...
			if ($input.is(":visible"))
		        ...
		        config.onOk();
//			console.log($(this).hasClass('notClose'))
