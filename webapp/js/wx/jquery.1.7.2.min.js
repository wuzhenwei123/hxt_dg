...
/*tab切换函数*/
jQuery.tab = function(tabid){
	var onatv = _chk(arguments[1]);						//mouseover OR click;
	var clson = _chk(arguments[2])?arguments[2]:"on";	//tab Activity
	var conid = _chk(arguments[3])?arguments[3]:tabid+"_con";		//content id
...
jQuery(document).ready(function($) {
    ...
    $(".pt_rtsb li:first-child a").trigger("click");
	...
	$("a[name='download']").bind("click",function(){
		...
		if(url.indexOf("read-")){
			var itemid = url.indexOf(".htm")==-1?url.substring(url.indexOf("read-")+5):url.substring(url.indexOf("read-")+5,url.indexOf(".htm"));
		}
		window.open("index.php?do-download-"+itemid);
	});    
});