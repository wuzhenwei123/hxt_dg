...
<input type="hidden" id="returnNum1" value="10"><!-- 分页返回 -->
    <form id="addForm" class="well well-nice form-horizontal">
         <div class="control-group">
             ...
             <div class="controls">
             	<c:if test="${empty hproxymessage.biangengUrl}">
             		暂无合同
             	</c:if>
             	<c:if test="${not empty hproxymessage.biangengUrl}">
			    	<img alt="" src="${pic_front}${hproxymessage.biangengUrl}" style="width:300px;height:100px;" onclick="preview('${hproxymessage.biangengUrl}',this)">
             	</c:if>
             </div>
         </div>
         <div class="control-group">
             ...
             <div class="controls">
			   <input type="radio" name='verify_type' checked="checked" value="1" onclick="changeType(7)">通过
			   <input type="radio" name='verify_type' value="8" onclick="changeType(8)">驳回
             </div>
         </div>
