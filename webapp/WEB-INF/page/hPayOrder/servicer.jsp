...
<script type="text/javascript">
	...
	function setTableStr4(result, pageNo, returnNum){
	    ...
	    for (var k=0; k<result.items.length; k++){      
	        ...
	        tableStr += "<td style='float:right;'><input type=\"radio\" value='"+result.items[k].id+"' id='"+result.items[k].id+"' class=\"checkbox check-row\" value=\"0\" name=\"servicerRadio\" onclick=\"servicerSure("+result.items[k].adminId+",\'"+result.items[k].realName+"\');\"/></td>";
