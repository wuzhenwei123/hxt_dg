...
<div class="modal-body">
    <form id="addForm" class="well well-nice form-horizontal">
         ...
         <div class="control-group">
             <label class="control-label" for="aProvinceName">provinceName</label>
             <div class="controls">
			    <input type="text" placeholder="provinceName" id="aProvinceName" isNotNull="true" warnName="provinceName" />
                 <span class="help-inline text-red">*</span>
             </div>
         </div>
     </form>
...
<script type="text/javascript">
	...
	function add(){
		...
		var provinceName = getVal("aProvinceName");
		var flag = validateForm('addForm');
	    if (flag){ 
	        $.post("<c:url value='/hProvince/addHProvince'/>",
	        	{
		    		id : id,
