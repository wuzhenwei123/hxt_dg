...
<div class="box minBox">
    <div class="pTitle"><a href="${ctx }/public/newslist?sortColumn= a.id desc ">服务要闻</a><span>></span><span>${news.title }</span></div>
    
    <div class="newsContentBox">
        <div class="newsTitlle">
            <h1>${news.title }</h1>
            <p>时间：<fmt:formatDate value="${news.createTime}" type="date"/></p>
        </div>
...
<script type="text/javascript">
 var conetent = unescape('${news.content }');
