...
// 	itemTpl = itemTpl + '<ul class="clearAfter ItemuL"><li class="fl">客户抄表电银联B2B缴费</li><li class="fr"><font>{payTimeStr}</font></li></ul>';
	itemTpl = itemTpl + '<ul class="clearAfter ItemuL"><li class="fl">客户抄表电银联B2B缴费</li><li class="fr"><font>+{rateMoney}</font></li></ul>';
	itemTpl = itemTpl + '<ul class="clearAfter ItemuL zhmxBox"><li class="fl">{payTimeStr}</li><li class="fr right"><span class="money"></span></li></ul>';
	itemTpl = itemTpl + '<span class="clear"></span></div>';	
	var itemTpl4 = '<div class="bsBox ItemLi zhmx marginTop16" onclick="window.location.href=\'${ctx}/weixin/accDetail/1/{o_id}\'">';
// 	itemTpl = itemTpl + '<ul class="clearAfter ItemuL"><li class="fl">客户抄表电银联B2B缴费</li><li class="fr"><font>{payTimeStr}</font></li></ul>';
	itemTpl4 = itemTpl4 + '<ul class="clearAfter ItemuL"><li class="fl">客户抄表电手机缴费</li><li class="fr"><font>+{rateMoney}</font></li></ul>';
	itemTpl4 = itemTpl4 + '<ul class="clearAfter ItemuL zhmxBox"><li class="fl">{payTimeStr}</li><li class="fr right"><span class="money"></span></li></ul>';
	itemTpl4 = itemTpl4 + '<span class="clear"></span></div>';	
	var itemTpl1 = '<div class="bsBox ItemLi zhmx marginTop16" onclick="window.location.href=\'${ctx}/weixin/accDetail/2/{id}\'">';
// 	itemTpl1 = itemTpl1 + '<ul class="clearAfter ItemuL"><li class="fl">{agentName}的交易</li><li class="fr"><font>{payTimeStr}</font></li></ul>';
	itemTpl1 = itemTpl1 + '<ul class="clearAfter ItemuL"><li class="fl">提现</li><li class="fr"><font>-{rateMoney}</font></li></ul>';
	itemTpl1 = itemTpl1 + '<ul class="clearAfter ItemuL zhmxBox"><li class="fl">{payTimeStr}</li><li class="fr right"><span class="money" style="color:#01a796"></span></li></ul>';
	itemTpl1 = itemTpl1 + '<span class="clear"></span></div>';	
	var itemTpl2 = '<div class="bsBox ItemLi zhmx marginTop16" onclick="window.location.href=\'${ctx}/weixin/accDetail/3/{o_id}\'">';
// 	itemTpl1 = itemTpl1 + '<ul class="clearAfter ItemuL"><li class="fl">{agentName}的交易</li><li class="fr"><font>{payTimeStr}</font></li></ul>';
	itemTpl2 = itemTpl2 + '<ul class="clearAfter ItemuL"><li class="fl">客户注册</li><li class="fr"><font>+{rateMoney}</font></li></ul>';
	itemTpl2 = itemTpl2 + '<ul class="clearAfter ItemuL zhmxBox"><li class="fl">{payTimeStr}</li><li class="fr right"><span class="money" style="color:#01a796"></span></li></ul>';
	itemTpl2 = itemTpl2 + '<span class="clear"></span></div>';	
	/**
	 * 载入内容
...
// 				}
				for(var i in testData) {
					$("#allCount").html(testData[i].allCount);
					$("#allDetailFee").html(testData[i].allDetailFee);
					$("#allMoney").html(testData[i].allMoney);
					if(testData[i].type==1){
						if(testData[i].pay_style==1){
							$("#zd-item").append(renderTpl(itemTpl, testData[i]));
						}else{
							$("#zd-item").append(renderTpl(itemTpl4, testData[i]));
						}
					}else if(testData[i].type==2){
						$("#zd-item").append(renderTpl(itemTpl1, testData[i]));
					}else if(testData[i].type==3){
