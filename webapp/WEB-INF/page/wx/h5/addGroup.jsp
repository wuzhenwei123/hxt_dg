...
<div class="box">
    <div class="topBox"><a class=" offen_back" href="javascript:history.go(-1);"></a>添加分组信息</div>
...
<!--             <div class="ui_center_left fl_title"><span class="">分组名称：</span></div> -->
            ...
            <div class="ui_center ui_cell_flex">
            	<div class="textarea" id="m_sub_name"></div>
        ...
        <div class="ui_cell ui_cells">
            ...
            <div class="ui_center ui_cell_flex">
            	<input id="m_consignee" class="offen_text offen_ui_text" type="text" >
            </div>
        </div>
        <div class="ui_cell ui_cells">
            <div class="ui_center_left "><font class="redColor">*</font>收件人手机号码：</div>
            <div class="ui_center ui_cell_flex">
            	<input id="m_consignee_phone" class="offen_text offen_ui_text" type="text">
            </div>
        </div>
        <div class="ui_cell ui_cells">
            <div class="ui_center_left "><font class="redColor">*</font>邮政编码：</div>
            <div class="ui_center ui_cell_flex">
            	<input id="m_zip_code" class="offen_text offen_ui_text" type="text">
            </div>
        </div>
        <div class="ui_cell ui_cells">
        ...
        <div class="ui_cell ui_cells">
            ...
            <div class="ui_center ui_cell_flex">
            	<div class="textarea" id="m_consignee_address"></div>
                <font class="accJiaojian"></font>
            </div>
        </div>                                                   
    </div>
