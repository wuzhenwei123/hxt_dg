...
<div class="box">
    ...
    <div class="jf_jg_box no">
    	<div class="jf_jg_number">￥${fee}</div>
        <div class="jf_type_box"><i></i>支付失败</div>
        <div class="jf_f_msg">
        	<span class="line">失败代码：</span><span>${msg}</span>
        </div>
    </div>
    ...
    <div class="itemsContentBox on jfjg_btn_box">
    	<a id="OkBtnBox" class="btn btn_primary fl" href="${pic_front}/weixin/payCheck?openId=${admin_user.openId}">返回主页</a>
