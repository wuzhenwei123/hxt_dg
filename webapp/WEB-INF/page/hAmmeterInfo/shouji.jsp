...
// 		    var profit_id = $("#fProfit_id").val();
	    ...
	    $.getJSON("<c:url value='/hAmmeterInfo/shoujiList'/>",
        {
...
// 	    	str+= "<th class=\"sortTh\" id=\"th_update_time\" width='135' column='update_time' onselectstart='return false' scope=\"col\">update_time</th>";
	    	...
	    	str+= "<th class=\"sortTh\" id=\"th_ammeter_address\" column='ammeter_address' onselectstart='return false' scope=\"col\">用电地址</th>";
...
// 	    	str+= "<th class=\"sortTh\" id=\"th_profit_id\" column='profit_id' onselectstart='return false' scope=\"col\">profit_id</th>";
	    	...
	    	str+= "<th class=\"sortTh\" id=\"th_profit_id\" column='profit_id' onselectstart='return false' scope=\"col\">代理人员分润</th>";
...
// 	    	str+= "<th class=\"sortTh\" id=\"th_is_payed\" column='is_payed' onselectstart='return false' scope=\"col\">is_payed</th>";
	    	...
	    	str+= "<th class=\"sortTh\" id=\"th_delete_state\" column='delete_state' onselectstart='return false' scope=\"col\">单位联系人姓名</th>";
	    	str+= "<th class=\"sortTh\" id=\"th_delete_state\" column='delete_state' onselectstart='return false' scope=\"col\">客户经理</th>";
	    	str+= "<th class=\"sortTh\" id=\"th_delete_state\" column='delete_state' onselectstart='return false' scope=\"col\">代理</th>";
	    	str+= "<th class=\"sortTh\" id=\"th_delete_state\" column='delete_state' onselectstart='return false' scope=\"col\">服务人员</th>";
	    	str+= "<th class=\"sortTh\" id=\"th_delete_state\" column='delete_state' onselectstart='return false' scope=\"col\">手机缴费负责人姓名</th>";
	    	str+= "<th class=\"sortTh\" id=\"th_delete_state\" column='delete_state' onselectstart='return false' scope=\"col\">手机缴费负责人手机</th>";
			str+="</tr></thead>";
		return str;
	}
