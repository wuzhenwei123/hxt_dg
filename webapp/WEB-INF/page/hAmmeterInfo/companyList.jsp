...
<div id="stack2" class="modal hide fade" tabindex="-1" data-focus-on="input:first" data-width="50%">
...
//     	str+= "<th class=\"sortTh\" id=\"th_ywyId\" column='ywyId' onselectstart='return false' scope=\"col\">业务员</th>";
	...
	function setTableStr2(result, pageNo, returnNum){
	    ...
	    for (var k=0; k<result.items.length; k++){      
	        ...
	        tableStr += "<td style='float:right;'><input type=\"radio\" value='"+result.items[k].id+"' id='"+result.items[k].id+"' class=\"checkbox check-row\" value=\"0\" name=\"companyRadio\" onclick=\"companySure("+result.items[k].id+",\'"+result.items[k].contact_phone+"\');\"/></td>";
