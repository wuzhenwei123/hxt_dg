...
<%@ include file="/WEB-INF/page/sys/manageAdminUserPP/guliYL.jsp" %>
 <%@ include file="/WEB-INF/page/sys/manageAdminUserPP/guliSJ.jsp" %>
 <a href="#stack2" id="sss" style="display: none;" class="btn btn-primary btn-large btn-block" data-toggle="modal">Demo - Modal Stacled</a>
<a href="#stack5" id="ssss" style="display: none;" class="btn btn-primary btn-large btn-block" data-toggle="modal">Demo - Modal Stacled</a>
...
<script type="text/javascript">
		...
		function searchData(pageNo){
		    ...
		    $.getJSON("<c:url value='/manageAdminUser/getManageAdminUserPP'/>",
	        {
...
// 		    	str+= "<th scope=\"col\" width='50' >创建人</th>";
		...
		function setTableStr(result, pageNo, returnNum){
		    ...
		    for (var k=0; k<result.items.length; k++){      
		        ...
		        tableStr += "<perm:tag permPath='/manageAdminUser/payGuliYL' ><a class='btn btn-green btn-mini no-wrap' href='javascript:void(0);' onclick='payGuliYL(" + result.items[k].adminId + "," + result.items[k].gl_yl_id + ");return false;'>银联缴费鼓励金匹配</a></perm:tag>";
	        	tableStr += "<perm:tag permPath='/manageAdminUser/payGuliSJ' ><a class='btn btn-blue btn-mini no-wrap' href='javascript:void(0);' onclick='payGuliSJ(" + result.items[k].adminId + "," + result.items[k].gl_sj_id + ");return false;'>手机支付鼓励金匹配</a></perm:tag>";
	        	tableStr += "</div>";
	        	tableStr += "</td>";
