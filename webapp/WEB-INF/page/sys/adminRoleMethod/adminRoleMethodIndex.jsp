  ...
  <div class="container">
          ...
          <div class="box_border">
            <div class="box_center pt10 pb10">
              <table class="search_table pr111" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
			        <th>mid:</th>
				    <td><input type="text" id="fMid" class="input-text lh25" size="10"></td>
	            </tr>
	        </table>
            </div>
	...
	<input type="hidden" id="sortColumn" value=""><!-- 排序字段 -->
     ...
     <div id="button" class="mt10" style="float: ${system_skins.skStyle}">
       ...
       <perm:tag permPath="/adminRoleMethod/toAdd" >
   ...
   <script type="text/javascript">
		...
		function searchData(pageNo){
		    ...
		    var mid = $("#fMid").val();
		    $.getJSON("<c:url value='/adminRoleMethod/getAdminRoleMethodList'/>",
	        {
		...
		function genTableHeader(){
			var str = "<tr>" ;
		    	...
		    	str+= "<th onselectstart='return false' class='sortTh' id='th_mid' column='mid' >mid</th>";
				str+="<th>操	作</th>";
				str+="</tr>";
			return str;
		}
		...
		function toUpdate(id) {
			top.art.dialog.open('<c:url value="/adminRoleMethod/toUpdate/'+id+'"/>',
			{
				id:123,
				fixed:true,
				esc:true,
				title:'adminRoleMethod',
				width: '730px',
				height:'400px',
			    cancelVal: '取消',
   		...
   		function update(iframe){
			...
			var flag = true ;
		    if (flag){ 
		        $.post("<c:url value='/adminRoleMethod/updateAdminRoleMethod'/>",
		        	{
		    		id : id,
		    		roleId : roleId,
		    		mid : mid,
   		...
   		// 添加
   		function toAdd(){
   			top.art.dialog.open('<c:url value="/adminRoleMethod/toAdd"/>',
			{
				id:456,
				fixed:true,
				esc:true,
   		...
   		function add(iframe){
			...
			var flag = true ;
		    if (flag){ 
		        $.post("<c:url value='/adminRoleMethod/addAdminRoleMethod'/>",
		        	{
		    		id : id,
		    		roleId : roleId,
		    		mid : mid,
