...
<div id="stack3" class="modal hide fade" tabindex="-1" data-focus-on="input:first" data-width="80%">
...
<script type="text/javascript">
	...
	function setTableStr3(result, pageNo, returnNum){
	    ...
	    for (var k=0; k<result.items.length; k++){      
	        ...
	        if(result.items[k].id==gl_sj_id){
		        tableStr += "<td style='float:right;'><input checked type=\"radio\" value='"+result.items[k].name+"' id='"+result.items[k].id+"' class=\"checkbox check-row\" name=\"ylOneRadio\"/></td>";
	        }else{
	...
	function agentOneSure1(glsjid,glsjname){
		$.post("<c:url value='/hAgent/setGlSJ'/>",
	        	{
					glsjid	:glsjid,
					id	:agentId,
					glsjname	:glsjname,
