...
public final class WxMsgKit {
	...
	static {
		// 文本消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_TEXT, new WxRecvTextMsgParser());
		// 链接消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_LINK, new WxRecvLinkMsgParser());
		// 地址消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_LOCATION, new WxRecvGeoMsgParser());
		// 图片消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_IMAGE, new WxRecvPicMsgParser());
		// 事件消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_EVENT, new WxRecvEventMsgParser());
		// 语音消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_VOICE, new WxRecvVoiceMsgParser());
		// 视频消息解析程序
		recvParserMap.put(Constants.RECV_TYPE_VIDEO, new WxRecvVideoMsgParser());
	}
