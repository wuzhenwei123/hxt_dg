package com.hxt.hAgentTwo.model;
 ...
 */
public class HAgentTwo extends BaseModel implements java.io.Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
		...
		private String oneAgentOpenId;//一级代理
		
		private Integer reg_gl_id;//注册鼓励金ID
		...
		private String reg_gl_name;//注册鼓励金ID
		private Double reg_gl_fee;//注册鼓励金ID
		
		private Integer reg_gl_id1;//注册鼓励金ID
		...
		public Integer getReg_gl_id1() {
			return reg_gl_id1;
		}

		public void setReg_gl_id1(Integer reg_gl_id1) {
			this.reg_gl_id1 = reg_gl_id1;
		}

		public Double getReg_gl_fee() {
			return reg_gl_fee;
		}

		public void setReg_gl_fee(Double reg_gl_fee) {
			this.reg_gl_fee = reg_gl_fee;
		}

		public String getReg_gl_name() {
			return reg_gl_name;
		}

		public void setReg_gl_name(String reg_gl_name) {
			this.reg_gl_name = reg_gl_name;
		}
		...
		public Integer getReg_gl_id() {
			return reg_gl_id;
		}

		public void setReg_gl_id(Integer reg_gl_id) {
			this.reg_gl_id = reg_gl_id;
		}
