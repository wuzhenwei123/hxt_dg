...
public class ColumnMethodController extends BaseController
{
	 ...
	 * @Description: 添加操作方法
	 */
	@RequestMapping(value = "/toAddMed/{columnId}", method = RequestMethod.GET)
	public String toAddMed(@PathVariable Integer columnId,HttpServletRequest request, HttpServletResponse response, Model model)
	{
	...
	@RequestMapping(value = "/toUpdate/{mid}", method = RequestMethod.GET)
	public String toUpdate(@PathVariable Integer mid, HttpServletRequest request, HttpServletResponse response, Model model)
	{	
